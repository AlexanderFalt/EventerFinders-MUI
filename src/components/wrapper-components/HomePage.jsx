...
import EventsLargeContent from '../base-components/contents/HomeLargeContent.jsx';
import EventsSmallContent from '../base-components/contents/HomeSmallContent.jsx';
        ...
        <Box sx={{ 
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    {isMediumScreen ? <EventsSmallContent /> : <EventsLargeContent />}
                </Box>
            </Box>
        </Box>
    );
